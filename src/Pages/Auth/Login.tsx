...
export default function Login() {
    const { register,setValue , handleSubmit, formState: { errors },} = useForm<SigninFormValues>()
  ...
  return (
    <div className="text-xl font-manrope line-clamp-4 py-8 flex flex-col gap-2 min-h-screen items-center justify-center">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-2 text-base py-4">
            ...
            <div className="py-8">
                <button type="submit" className="w-full py-1 bg-violet-600 text-white rounded shadow-md shadow-violet-400 ">Login</button>
