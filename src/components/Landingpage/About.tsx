...
export default function About() {
  return (
    <div className="xs:px-4 md:px-28 py-2">
      <div className='flex xs:flex-col xs:items-center md:flex-row md:justify-between xs:px-2 md:px-12 py-1 gap-10'>
        <img src={AboutImage} alt="aboutimg" className='md:w-[21rem] xs:w-96 xs:h-60 md:max-w-[30rem] md:h-[20rem] md:max-h-[30rem] rounded-md shadow-xl shadow-violet-200 transition-transform duration-300 hover:scale-105 hover:-translate-y-4'/>
        <div>
            ...
            <div className='grid grid-cols-3 gap-1 py-8 xs:text-center md:px-10'>
