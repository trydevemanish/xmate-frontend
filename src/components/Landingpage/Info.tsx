...
export default function Info() {
  return (
    <div className="bg-violet-300">
        <div className="xs:px-6 md:px-32 py-16 xs:flex xs:flex-col xs:gap-16 md:grid md:grid-cols-2"> 
            <div className='xs:hidden xs:invisible md:block md:visible md:col-start-1 md:col-end-2'>
            ...
            <div className='md:col-start-2 md:col-end-3 flex flex-col'>
